...
private static final long serialVersionUID = 0L;
  ...
  public static final int DESCIPTION_FIELD_NUMBER = 4;
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (!getDesciptionBytes().isEmpty()) {
      com.google.protobuf.GeneratedMessageV3.writeString(output, 4, desciption_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!getDesciptionBytes().isEmpty()) {
      size += com.google.protobuf.GeneratedMessageV3.computeStringSize(4, desciption_);
    }
    if (!getTypeBytes().isEmpty()) {
