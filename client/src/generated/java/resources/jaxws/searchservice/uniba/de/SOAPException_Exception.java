 ...
 * 
 */
@WebFault(name = "SOAPException", targetNamespace = "de.uniba.searchservice.jaxws.resources")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: resources.jaxws.searchservice.uniba.de.SOAPException
     */
